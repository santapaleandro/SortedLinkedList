...
public class SortedLinkedListTest {
  ...
  @Test
  public void addSortedLinkedList() {
  ...
  @Test
  public void checkPreviousOfHeadElement() {
    sortedLinkedList.add(1);
  ...
  @Test
  public void checkNextOfLastElement() {
    sortedLinkedList.add(1);
    assertNull(sortedLinkedList.last.next);
  }

  @Test
  public void checkNextOfHeadElement() {
    sortedLinkedList.add(1);
    assertEquals(sortedLinkedList.get(1), sortedLinkedList.head.next.data);
  }

  @Test
  public void checkPreviousOfLastElement() {
    sortedLinkedList.add(1);
  ...
  public void stream() {
    ...
    sortedLinkedList.add(5);
    List<Integer> list = sortedLinkedList.stream().map(integer -> integer + 3).toList();
    assertEquals(list.get(0).intValue(), 5);
    assertEquals(list.get(1).intValue(), 8);
  }
}
